...
const mockTransform = (await import('../src/util/transform') as any)
  .transform as MockedFunction<typeof import('../src/util/transform').transform>;
...
describe('Transformation integration', () => {
  ...
  it.skip('should apply test.options.transform and assert.contextTransform from provider output', async () => {
    ...
    mockTransform.mockImplementation(async function(expression, input) {
