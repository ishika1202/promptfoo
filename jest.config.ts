...
const config: Config = {
  ...
  testPathIgnorePatterns: [
    ...
    '<rootDir>/test/redteam/constants.test.ts',
    '<rootDir>/test/redteam/constants/metadata.test.ts',
    '<rootDir>/test/redteam/constants/plugins.test.ts',
    '<rootDir>/test/redteam/constants/strategies.test.ts',
    '<rootDir>/test/redteam/metrics.test.ts',
    '<rootDir>/test/redteam/riskScoring.test.ts',
    '<rootDir>/test/redteam/sharedFrontend.test.ts',
    '<rootDir>/test/redteam/types.test.ts',
    '<rootDir>/test/redteam/util.test.ts',
    '<rootDir>/test/redteam/strategies/base64.test.ts',
    '<rootDir>/test/redteam/strategies/bestOfN.test.ts',
    '<rootDir>/test/redteam/strategies/crescendo.test.ts',
    '<rootDir>/test/redteam/strategies/custom.test.ts',
    '<rootDir>/test/redteam/strategies/goat.test.ts',
    '<rootDir>/test/redteam/strategies/hex.test.ts',
    '<rootDir>/test/redteam/strategies/homoglyph.test.ts',
    '<rootDir>/test/redteam/strategies/hydra.test.ts',
    '<rootDir>/test/redteam/strategies/iterative.test.ts',
    '<rootDir>/test/redteam/strategies/layer.test.ts',
    '<rootDir>/test/redteam/strategies/leetspeak.test.ts',
    '<rootDir>/test/redteam/strategies/mischievousUser.test.ts',
    '<rootDir>/test/redteam/strategies/otherEncodings.test.ts',
    '<rootDir>/test/redteam/strategies/promptInjections.test.ts',
    '<rootDir>/test/redteam/strategies/retry.test.ts',
    '<rootDir>/test/redteam/strategies/rot13.test.ts',
    '<rootDir>/test/redteam/strategies/strategyId.test.ts',
    '<rootDir>/test/redteam/remoteGeneration.test.ts',
    '<rootDir>/test/redteam/graders.test.ts',
  ],
  transform: {
    '^.+\\.m?[tj]sx?$': '@swc/jest',
  },
